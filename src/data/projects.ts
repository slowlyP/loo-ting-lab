...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      '랜덤 마법사 소환, 일반 마법사 융합, 속성 융합, 전설 마법사와의 시너지 실험을 중심으로 만든 개인 포트폴리오용 캐주얼 판타지 타워디펜스입니다. PC / Steam 지향 플레이 가능 프로토타입으로 방향성을 정리 중입니다.',
    ...
    detail: {
      overview: [
        'Wizard Defense는 Random Wizard Defense라는 이름으로 개발 중인 개인 포트폴리오 게임 프로젝트입니다.',
      ...
      coreStructure: [
        ...
        '속성 융합은 불, 물, 바람, 돌, 번개 조합을 중심으로 설계하고 있으며, 증기 폭발, 용암 지대, 진흙 수렁, 천둥구름, 자력 붕괴 같은 2티어 마법사 스킬을 실험 중입니다.',
      ],
      responsibilities: [
      ...
      implementationStatus: {
        ...
        inProgress: [
          ...
          '2티어 융합 스킬과 전설 마법사 시너지가 게임의 선택 요소로 작동하도록 실험 중',
        ],
        planned: [
      ...
      media: {
        screenshots: [],
        videos: [],
        note: '상세 페이지에는 현재 플레이 영상과 대표 preview 이미지를 연결했습니다. Steam 페이지나 외부 데모 링크는 준비되면 별도로 추가할 예정입니다.',
      },
    },
    links: {
      github: '',
