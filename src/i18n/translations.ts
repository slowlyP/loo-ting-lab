...
export const translations: Record<'ko' | 'en', TranslationTree> = {
  ko: {
    ...
    common: {
      ...
      viewResource: '자료 보기', viewPdf: 'PDF 보기', openService: '서비스 열기', more: '개 더 보기',
    },
    ownership: { team: '팀 프로젝트', personal: '개인 프로젝트', personalData: '개인 데이터 프로젝트' },
    work: {
      ...
      teamTitle: 'Team Projects', teamDescription: '팀으로 진행한 AI 서비스 / 도로 안전 프로젝트입니다.',
      personalTitle: 'Personal Projects', personalDescription: '개인적으로 기획하고 구현한 게임 / 데이터 프로젝트입니다.',
    },
    about: {
      ...
      resumeNote: '프로젝트 경험과 기술을 정리한 이력서', githubNote: '코드와 프로젝트 기록', emailNote: '프로젝트 및 채용 관련 연락', portfolioNote: '이 포트폴리오의 설계, 구현, 배포 과정을 정리한 상세 프로젝트',
    },
    detail: {
      ...
      systemFlow: 'System Flow', teamContribution: '팀 범위와 개인 기여', evidence: '근거 자료',
      scopeLimitations: '범위와 제한 사항', verification: '검증', deployment: '배포 구조',
      milestones: '주요 단계', liveDemoNotice: 'Live Demo 안내',
    },
  ...
  en: {
    ...
    common: {
      ...
      viewPdf: 'View PDF', openService: 'Open Live Site', more: 'more',
    },
    ownership: { team: 'Team Project', personal: 'Personal Project', personalData: 'Personal Data Project' },
    work: {
      ...
      teamTitle: 'Team Projects', teamDescription: 'AI service and road safety projects built with team collaboration.',
      personalTitle: 'Personal Projects', personalDescription: 'Game and data projects planned and developed personally.',
    },
    about: {
      ...
      resumeNote: 'A concise record of my projects and skills', githubNote: 'Code and project documentation', emailNote: 'Project and recruiting inquiries', portfolioNote: 'A case study of this portfolio’s design, implementation, and deployment',
    },
    detail: {
      ...
      projectType: 'Project Type',
      systemFlow: 'System Flow', teamContribution: 'Team Scope & Contribution', evidence: 'Evidence & Sources',
      scopeLimitations: 'Scope & Limitations', verification: 'Verification', deployment: 'Deployment',
      milestones: 'Milestones', liveDemoNotice: 'Live Demo Notice',
    },
