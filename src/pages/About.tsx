const interests = [
  'React와 TypeScript 기반의 포트폴리오/웹 UI 구성',
  'Unity와 C#을 활용한 게임 시스템 구조 이해',
  '한국어 데이터셋 설계와 라벨링 기준 정리',
  'AI 지원 시스템에서 데이터, 규칙, 검증 기록이 연결되는 방식',
]
  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        <p className="text-sm font-semibold uppercase text-cyan-300">ABOUT</p>
      ...
      <section className="rounded-lg border border-violet-400/30 bg-slate-900 p-6">
        ...
        <p className="mt-3 max-w-4xl leading-7 text-slate-300">
          ...
          데이터셋 설계를 각각 경험했고, 현재는 이 경험을 취업용 포트폴리오로
          설명 가능한 형태로 다듬고 있습니다.
        </p>
      </section>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-lg border border-slate-700 bg-slate-900 p-5">
          <h2 className="text-xl font-bold text-white">관심 분야</h2>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-lg border border-slate-700 bg-slate-900 p-5">
          ...
          <p className="mt-3 leading-7 text-slate-300">
            ...
            있습니다. 특히 프로젝트별 역할, 사용 기술, 문제 해결, 검증 결과,
            남은 한계를 분리해 신뢰할 수 있는 설명을 만드는 데 집중하고
            있습니다.
          </p>
        </div>
      </section>
      ...
      <section className="rounded-lg border border-slate-700 bg-slate-900 p-5">
        ...
        <p className="mt-3 max-w-4xl leading-7 text-slate-300">
          웹 프론트엔드 구현 역량을 바탕으로, 게임 시스템과 데이터/AI 지원
