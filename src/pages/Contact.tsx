const projectLinks = [
  ...
  },
  {
    ...
    description: 'AI 기반 고속도로 돌발 상황 감지/관제 프로젝트 저장소',
  },
]

const contactTopics = [
  'React / TypeScript 기반 포트폴리오와 UI 구현 경험',
    ...
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="max-w-3xl leading-7 text-slate-300">
          포트폴리오와 프로젝트 기록을 확인한 뒤 연락할 수 있도록 기본 링크를
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <div className="rounded-lg border border-slate-700 bg-slate-900 p-5">
          <h2 className="text-xl font-bold text-white">연락 안내</h2>
        ...
        <div className="rounded-lg border border-slate-700 bg-slate-900 p-5">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-3 inline-flex rounded-md border border-cyan-300 px-4 py-2 text-sm font-bold text-cyan-100 transition hover:bg-cyan-300/10"
          >
            slowlyP 계정 보기
          </a>
        </div>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-bold text-white">주요 프로젝트 링크</h2>
          ...
          {projectLinks.map((link) => (
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-4 inline-flex rounded-md border border-cyan-300/70 px-3 py-2 text-sm font-bold text-cyan-100 transition hover:bg-cyan-300/10"
              >
                링크 열기
              </a>
            </article>
      ...
      <section className="rounded-lg border border-slate-700 bg-slate-900 p-5">
        ...
        <p className="mt-3 max-w-4xl leading-7 text-slate-300">
          이 포트폴리오는 프로젝트 결과만 보여주기보다 어떤 문제를 다뤘고, 어떤
          구조로 정리했으며, 무엇을 검증했고, 어떤 한계가 남아 있는지 확인할 수
          있도록 구성했습니다. 아래 주제와 관련된 확인 요청을 받을 수 있도록
          연락 정보를 계속 정리할 예정입니다.
        </p>
