...
export function ProjectThumbnail({ project, isPreviewActive = false }: { project: Project; isPreviewActive?: boolean }) {
  ...
  return (
    <div className="relative aspect-[16/10] overflow-hidden bg-slate-100" aria-label={preview.alt}>
      ...
      <div className="absolute inset-x-6 bottom-5 flex items-end justify-between gap-4">
        <span className="max-w-[72%] text-xl font-black tracking-[-0.04em] text-slate-900 drop-shadow-[0_1px_0_rgba(255,255,255,.6)] sm:text-2xl">{project.title}</span>
