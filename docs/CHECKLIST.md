...
- [x] Work on `feature/v0.1-project-setup`.
- [x] Install Tailwind CSS.
- [x] Connect Tailwind CSS to Vite.
- [x] Install React Router.
- [x] Connect HashRouter routing.
- [x] Create `src/components`.
- [x] Create `src/data`.
- [x] Create `src/pages`.
- [x] Create basic pages.
- [x] Create basic layout and project components.
- [x] Create `src/data/projects.ts`.
- [x] Replace Vite sample UI with portfolio shell.
- [x] Initialize documentation files.
- [x] Run lint.
- [x] Run build.
- [x] Record test results in worklog.
...
- [x] Keep HashRouter paths unchanged.
- [x] Add Korean/English language state and Korean fallback.
- [x] Persist the language with `loo-ting-lab-language`.
- [x] Keep project facts, technology labels, and external links unchanged.
- [x] Redesign Work, About Me, and Project Detail for a bright gallery layout.
